...
export default function PixiJS_QuickGraphics() {
    ...
    return (
        <main
            className="flex flex-col items-center justify-between p-24 text-slate-50"
            style={{
                background:
        ...
        >
            ...
            <div className="flex flex-row w-max min-w-max h-max">
                <div className=" flex flex-col mx-20 w-72 text-xl">
                    ...
                    <button
                        className=" bg-cyan-300 hover:bg-cyan-500 text-gray-700 font-bold py-2 px-4 rounded-full my-5 text-lg"
                    ...
                    <div className="flex h-full items-end justify-between py-5">
                        <button
                            className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full text-lg"
                            onClick={reset}
                        >
                            清空圖形
                        </button>
                        <button
                            className=" bg-slate-300 hover:bg-slate-400 text-gray-700 font-bold py-2 px-4 rounded-full text-lg"
                            onClick={removeLast}
                        >
                            上一步
                        </button>
            ...
            <div className="flex flex-row w-full min-w-max h-max my-20 bg-amber-400">
                <More />
            </div>
        </main>
    );
